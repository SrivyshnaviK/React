...
export default function CustomizedMenus(props) {
  ...
  const names=["Entrepreneurship","Politics","Science","Education","Economics","Motivation","Health","Communication Skills","Relationships"];
  const icons=[faRocket,faLandmark,faFlask,faGraduationCap,faGlobeAsia,faLightbulb,faHeartbeat,faComment,faHeart];
  var i=0;
  const toggle=()=>{
    if(expand===0)
    {
