...
class TemperatureInput extends React.Component {
    ...
    handleChange(e) {
        this.props.onTemperatureChange(e.target.value); // using common
    }

    render() {
        const temperature = this.props.temperature; //coming from Calculator
...
class Calculator extends React.Component {
    ...
    render() {
        const scale = this.state.scale; const temperature = this.state.temperature;
